...
/**
 * The Package class represents event packages offered by vendors
 */
...
public class Packages {
	...
	public String toString() {
		return "Packages [TypeOfEvent=" + TypeOfEvent + ", PackageType=" + PackageType + ", decoration=" + decoration
				+ ", photography=" + photography + ", catering_veg=" + catering_veg + ", catering_nonveg="
				+ catering_nonveg + ", otherservice=" + otherservice + "]";
	}
