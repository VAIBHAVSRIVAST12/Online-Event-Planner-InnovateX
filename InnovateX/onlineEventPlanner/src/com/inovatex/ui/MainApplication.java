			...
			case 2:{
				...
				if(vendorLoginResult) {
					...
					while(vendorChoice!=5) {
						...
						System.out.println("5. Logout Vendor");
						...
						case 3:{
							...
							} catch (PlanRequestNotFoundExceptions | UserNotFoundExceptions e) {
								System.err.println(e.getMessage());
							}
				...
				if(userLoginResult) {
					...
					while(userChoice!=6) {
						...
						try {
							...
							List<Quotation> quotationList = vendorService.viewQuotation(username);
