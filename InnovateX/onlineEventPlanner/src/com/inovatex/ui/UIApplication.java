...
//				}
				...
				try {
					Vendor vendor = vendorService.getVendorByVendorId(username);
			...
			case 8:{
				...
				try {
					int rows= userService.deletePlanRequest(requestId);
					if(rows>0)
						System.out.println("Deleted");
					else
						System.out.println("Not-Deleted");
			...
			case 9:{
				try {
					...
					List<PlanRequest> planRequestList = userService.allRequest();
